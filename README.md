...
[42서울(42seoul)](#ecole42)의 6기 수료생입니다. 프로젝트를 분석해 요구 조건을 명확히하고 각 상황에서의 예외처리를 정리해 구현하고 프로그램의 구조에 따라 시점에 따른 데이터를 고려하며 개발합니다.. 또한 동료평가의 경험을 통해 타인의 코드를 이해하거나 본인의 코드를 설명하는 것에 능숙합니다<br>
